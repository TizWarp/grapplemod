...
public class ClientSetup {
	...
	public static KeyMapping key_boththrow = createKeyBinding(new KeyMapping("key.boththrow.desc", CustomKeyConflicts.INGAME_NO_CONFLICT, InputConstants.getKey(InputConstants.MOUSE_BUTTON_RIGHT, -1), KeyMapping.CATEGORY_MISC));
